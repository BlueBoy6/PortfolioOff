...
componentDidUpdate(){
  ...
  render() {
      setTimeout(()=>{document.getElementById("logo").innerHTML = `
      
      <svg class="h-100 logo" version="1.1" viewBox="0 0 434 582" style="enable-background:new 0 0 434 582;" xml:space="preserve">
    ...
    return (
        <div className='row catch-top-app justify-content-center'>
            <div id="logoTop" className="h-100">
                <div id="logo"></div>
